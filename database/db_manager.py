...
def get_transactions(account_id):
    """Regresa todos los registros de trasacciones de un user id"""
    connection = sqlite3.connect(DB_Name)
    cursor = connection.cursor()
    cursor.execute("""
                   SELECT *
...
def get_table_users():
    """ Funcion para obtener los registros de usuarios capturados en tabla users."""
    connection = sqlite3.connect(DB_Name)
    cursor = connection.cursor()
    cursor.execute("""
                    SELECT *
...
def get_table_accounts():
    """ Funcion para obtener los registros de cuentas capturadas en tabla accounts."""
    connection = sqlite3.connect(DB_Name)
    cursor = connection.cursor()
    cursor.execute("""
                    SELECT *
...
def get_table_transactions():
    """Funcion para obtener los registros de transacciones en tabla transactions."""
    connection = sqlite3.connect(DB_Name)
    cursor = connection.cursor()
    cursor.execute("""
                    SELECT *
